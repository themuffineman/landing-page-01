  ...
  return (
    <>
      <h1 className="text-6xl tracking-tighter text-white">
        Built to empower <br />
        <span className="font-serif font-light italic">next level</span>{" "}
        expansion
      </h1>
      <p className="max-w-lg text-sm text-white">
        Trust Keith holds your hand to get you (and keep you!) as compliant as
        you need by giving you access to a dedicated human expert and an
...
export default function HeroPage() {
  return (
    <>
      <main className="flex min-h-screen max-w-400 mx-auto w-full flex-col items-center justify-center bg-[url('/hero-clouds.png')] bg-cover bg-no-repeat font-sans">
        <Nav />
        <section className="relative flex min-h-screen w-full flex-col items-center justify-center gap-2 pt-10 text-center">
